...
<html lang="en" data-bs-theme="auto">
  <head><script src="/js/color-modes.js"></script>
    ...
    <link rel="canonical" href="https://getbootstrap.kr/docs/5.3/examples/dashboard/">

    

    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/@docsearch/css@3">

<link href="/css/bootstrap.min.css" rel="stylesheet" integrity="QWTKZyjpPEjISv5WaRU9OFeRpok6YctnYmDr5pNlyT2bRjXh0JMhjY6hW+ALEwIH" crossorigin="anonymous">
...
<header class="navbar sticky-top bg-dark flex-md-nowrap p-0 shadow" data-bs-theme="dark">
  <a class="navbar-brand col-md-3 col-lg-2 me-0 px-3 fs-6 text-white" href="/">Home</a>
    ...
    <div class="sidebar border border-right col-md-3 col-lg-2 p-0 bg-body-tertiary" >
      <div class="offcanvas-md offcanvas-end bg-body-tertiary" tabindex="-1" id="sidebarMenu" aria-labelledby="sidebarMenuLabel">
        ...
        <div class="offcanvas-body d-md-flex flex-column p-0 pt-lg-3 overflow-y-auto">
          <ul class="mypage-nav-button nav flex-column">
            <li class="nav-item">
              <a value="dashBoard" class="nav-link d-flex align-items-center gap-2 active" aria-current="page" href="#">
            ...
            <li class="nav-item">
              <a value="account" class="nav-link d-flex align-items-center gap-2" href="#">
                <svg class="bi"><use xlink:href="#people"/></svg>
                계정관리
              </a>
            </li>
            <li class="nav-item">
              <a value="purchStat" class="nav-link d-flex align-items-center gap-2" href="#">
	      	...
	      	<c:if test="${principal.user.role eq 'USER'}">
	            <li class="nav-item">
	              <a value="" class="nav-link d-flex align-items-center gap-2" href="/boardList?userId=${principal.user.id}">
          ...
          <ul class="nav flex-column mb-auto mypage-nav-button">
            ...
            <li class="nav-item">
              <a value="return" class="nav-link d-flex align-items-center gap-2" href="/admin/returnProduct">
