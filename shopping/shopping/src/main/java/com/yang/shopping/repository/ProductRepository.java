...
public interface ProductRepository extends JpaRepository<Product, Integer>{
    ...
    @Query("SELECT f FROM FileInfo f WHERE f.product.productSeq = :productSeq ORDER BY f.fileSeq DESC")
    List<Product> getProductDetailFileInfo(@Param("productSeq") int id);
