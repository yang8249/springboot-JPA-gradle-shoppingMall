					...
					<div class="RW ">
						...
						<div class="prdImg ">
							<div class="img_wrap thumbnail" style="width: 500px;">
								<c:forEach var="img" items="${product.fileInfo}" varStatus="status">
    								<c:if test="${status.first}">
        								<img src="http://localhost:9000/upload/img/${img.uuid}"
             							alt="대표 이미지" class="img" loading="lazy" ez-prevent="img"
								...
								<ul class="list">
    								<c:forEach var="img" items="${product.fileInfo}">
       									<li class="xans-record-">
            								<img src="http://localhost:9000/upload/img/${img.uuid}" class="ThumbImage" alt="">
        								</li>
    								</c:forEach>
								</ul>
							</div>
